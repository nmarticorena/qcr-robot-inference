...
if self collision is desired you also required to have collision geometries in addition to a semantic robot description file.
...
For implementing an additional robot you required to add a urdf file in addition to a .srdf file.
