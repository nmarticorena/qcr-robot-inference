...
class SinglePandaConfig:
    """
    Config for frankx controller to keep the same args over all experiments
    """
    robot_ip:str = "172.16.0.2"

    # Controller
    cartesian_impedance:List[float] = [400.0, 400.0, 400.0, 40.0, 40.0, 40.0] # 
    ...
    # Task specific
    default_q = [0.0, -np.pi / 4, 0.0, -3 * np.pi / 4, 0.0, np.pi / 2, np.pi / 4]
